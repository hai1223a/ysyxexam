...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        if ((0U == vlSelfRef.top__DOT__count)) {
            __Vdly__led = ((0xfffcU & ((IData)(vlSelfRef.led) 
                                       << 2U)) | (3U 
                                                  & ((IData)(vlSelfRef.led) 
                                                     >> 0xeU)));
        }
        __Vdly__top__DOT__count = ((0x4c4b40U <= vlSelfRef.top__DOT__count)
                                    ? 0U : ((IData)(1U) 
...
#endif
            VL_FATAL_MT("/home/yunhai/ysyx-workbench/pre_study/led/vsrc/top.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/yunhai/ysyx-workbench/pre_study/led/vsrc/top.v", 1, "", "Active region did not converge.");
            }
