...
void printf_statu()
{
    ...
    Log("icache相关:访问次数 = %ld, 命中次数 = %ld, 命中率 = %ld, AMAT = %ld", npc_perC.icache_count, npc_perC.icache_hit, icache_hit_rate, icache_amat);
    // Log("dcache相关:访问次数 = %ld, 命中次数 = %ld, 命中率 = %ld, AMAT = %ld", );
