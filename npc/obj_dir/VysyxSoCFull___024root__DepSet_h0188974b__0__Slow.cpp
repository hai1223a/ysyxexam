...
VL_ATTR_COLD void VysyxSoCFull___024root___ctor_var_reset(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->ysyxSoCFull__DOT__asic__DOT__lgpio__DOT__mgpio__DOT__gpio_seg__BRA__7__03a0__KET__ = 0;
    ...
    vlSelf->ysyxSoCFull__DOT__sdram0_0__DOT__burst_len = 0;
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
    ...
    vlSelf->ysyxSoCFull__DOT__sdram0_1__DOT__burst_len = 0;
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
    ...
    vlSelf->ysyxSoCFull__DOT__sdram1_0__DOT__burst_len = 0;
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
    ...
    vlSelf->ysyxSoCFull__DOT__sdram1_1__DOT__burst_len = 0;
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
