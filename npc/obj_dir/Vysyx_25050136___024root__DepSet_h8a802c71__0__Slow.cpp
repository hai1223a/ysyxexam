...
VL_ATTR_COLD void Vysyx_25050136___024root___eval_settle(Vysyx_25050136___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25050136___024root___eval_settle\n"); );
...
#ifdef VL_DEBUG
            Vysyx_25050136___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("vsrc/soc.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vysyx_25050136___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vysyx_25050136___024root___eval_triggers__stl(Vysyx_25050136___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25050136___024root___eval_triggers__stl\n"); );
    Vysyx_25050136__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vysyx_25050136___024root___stl_sequent__TOP__0(Vysyx_25050136___024root* vlSelf);
...
VL_ATTR_COLD void Vysyx_25050136___024root___eval_stl(Vysyx_25050136___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25050136___024root___eval_stl\n"); );
    Vysyx_25050136__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_EXEC_TRACE_ADD_RECORD(vlSymsp).sectionPush("func stl");
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vysyx_25050136___024root___stl_sequent__TOP__0(vlSelf);
        Vysyx_25050136___024root____Vm_traceActivitySetAll(vlSelf);
    }
    VL_EXEC_TRACE_ADD_RECORD(vlSymsp).sectionPop();
}
...
VL_ATTR_COLD void Vysyx_25050136___024root___stl_sequent__TOP__0(Vysyx_25050136___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25050136___024root___stl_sequent__TOP__0\n"); );
    Vysyx_25050136__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((2U & (IData)(vlSelfRef.ysyx_25050136__DOT__u_ysyx_25050136_ARBITER__DOT__current_slaver))) {
        vlSelfRef.io_master_awsize = vlSelfRef.ysyx_25050136__DOT__u_ysyx_25050136_ARBITER__DOT__t_awsize;
