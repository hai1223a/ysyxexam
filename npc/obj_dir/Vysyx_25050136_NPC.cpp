...
Vysyx_25050136_NPC::Vysyx_25050136_NPC(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__ysyx_25050136_NPC{vlSymsp->TOP.__PVT__ysyx_25050136_NPC}
    , rootp{&(vlSymsp->TOP)}
{
...
std::unique_ptr<VerilatedTraceConfig> Vysyx_25050136_NPC::traceConfig() const {
...
void Vysyx_25050136_NPC___024root__trace_decl_types(VerilatedFst* tracep);

void Vysyx_25050136_NPC___024root__trace_init_top(Vysyx_25050136_NPC___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD static void trace_init(void* voidSelf, VerilatedFst* tracep, uint32_t code) {
    ...
    Vysyx_25050136_NPC___024root__trace_decl_types(tracep);
    Vysyx_25050136_NPC___024root__trace_init_top(vlSelf, tracep);
    tracep->popPrefix();
}

VL_ATTR_COLD void Vysyx_25050136_NPC___024root__trace_register(Vysyx_25050136_NPC___024root* vlSelf, VerilatedFst* tracep);

VL_ATTR_COLD void Vysyx_25050136_NPC::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedFstC* const stfp = dynamic_cast<VerilatedFstC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vysyx_25050136_NPC::trace()' called on non-VerilatedFstC object;"
            " use --trace-fst with VerilatedFst object, and --trace-vcd with VerilatedVcd object");
    }
    stfp->spTrace()->addModel(this);
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP));
    Vysyx_25050136_NPC___024root__trace_register(&(vlSymsp->TOP), stfp->spTrace());
}
