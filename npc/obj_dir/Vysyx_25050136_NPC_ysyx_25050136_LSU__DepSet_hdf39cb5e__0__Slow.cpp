...
VL_ATTR_COLD void Vysyx_25050136_NPC_ysyx_25050136_LSU___stl_sequent__TOP__ysyx_25050136_NPC__u_ysyx_25050136_EX__u_ysyx_25050136_LSU__0(Vysyx_25050136_NPC_ysyx_25050136_LSU* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vysyx_25050136_NPC_ysyx_25050136_LSU___stl_sequent__TOP__ysyx_25050136_NPC__u_ysyx_25050136_EX__u_ysyx_25050136_LSU__0\n"); );
...
VL_ATTR_COLD void Vysyx_25050136_NPC_ysyx_25050136_LSU___ctor_var_reset(Vysyx_25050136_NPC_ysyx_25050136_LSU* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vysyx_25050136_NPC_ysyx_25050136_LSU___ctor_var_reset\n"); );
    Vysyx_25050136_NPC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__mem_len_i = 0;
    vlSelf->__PVT__mem_signed_i = 0;
    vlSelf->__PVT__store_data_i = 0;
