module ysyx_25050136_ALU
    ...
    wire [31:0] add_sub_op2 = operation_i[`ysyx_25050136_ALU_SUB] ? ~op2_i + 1 : op2_i;
    ...
    always @(*) begin
        case (1'b1)
            operation_i[`ysyx_25050136_ALU_ADD  ]: out = add_sub_result[31:0];
            operation_i[`ysyx_25050136_ALU_SUB  ]: out = add_sub_result[31:0];
            ...
            operation_i[`ysyx_25050136_ALU_EQ   ]: out = {{31{1'b0}}, (~|op1_xor_op2)};
            operation_i[`ysyx_25050136_ALU_NEQ  ]: out = {{31{1'b0}}, (|op1_xor_op2)};
            operation_i[`ysyx_25050136_ALU_LEQ_U]: out = {{31{1'b0}},(op1_i < op2_i)};
            operation_i[`ysyx_25050136_ALU_GEQ_U]: out = {{31{1'b0}},(op1_i >= op2_i)};
            operation_i[`ysyx_25050136_ALU_LEQ  ]: out = {{31{1'b0}},($signed(op1_i) < $signed(op2_i))};
            operation_i[`ysyx_25050136_ALU_GEQ  ]: out = {{31{1'b0}},($signed(op1_i) >= $signed(op2_i))};
