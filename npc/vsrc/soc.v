module ysyx_25050136_SOC(
    ...
    ysyx_25050136_SRAM #(
        ...
        .aclk        (clk            ),
        .aresetn     (~reset         ),
        .s_awvalid_i (sram_awvalid_o ),
        .s_awready_o (sram_awready_i ),
        .s_awaddr_i  (sram_awaddr_o  ),
        .s_wvalid_i  (sram_wvalid_o  ),
        .s_wready_o  (sram_wready_i  ),
        .s_wdata_i   (sram_wdata_o   ),
        .s_wstrb_i   (sram_wstrb_o   ),
        .s_bvalid_o  (sram_bvalid_i  ),
        .s_bready_i  (sram_bready_o  ),
        .s_bresp_o   (sram_bresp_i   ),
        .s_arvalid_i (sram_arvalid_o ),
        .s_arready_o (sram_arready_i ),
        .s_araddr_i  (sram_araddr_o  ),
        .s_rvalid_o  (sram_rvalid_i  ),
        .s_rready_i  (sram_rready_o  ),
        .s_rdata_o   (sram_rdata_i   ),
        .s_rresp_o   (sram_rresp_i   )
    );
